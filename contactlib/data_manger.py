...
ASSETS = {
    ...
    "libsearch-2.0-macOS.so": Assest("https://pppublic.oss-cn-beijing.aliyuncs.com/tmp-server/libsearch-2.0-macOS.so", md5="30067f70bce39d1cd62f49c32a2b81f0"),
    "libsearch-2.0-linux-amd64.so": Assest("https://pppublic.oss-cn-beijing.aliyuncs.com/tmp-server/libsearch-2.0-linux-amd64.so", md5="e9c8461f78f348acff67a10fc64f72d6"),
